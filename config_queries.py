...
def initialize_dbs():
    databases = {
        ...
        'AttackonWikia/aow_db.db': [
            ...
            ('urls', ['url text', 'puzzle integer', 'hangman integer', 'image integer'])
        ],
        ...
        'WarriorsvsSoldiers/wvs_db.db': [
            ...
            'hunter_wins integer', 'hunter_games integer', 'saboteur_wins integer', 'saboteur_games integer', 'decoy_wins integer', 'decoy_games integer', 'cadet_wins integer', 'cadet_games integer']),
            ...
            'decoy_wins integer', 'decoy_games integer', 'cadet_wins integer', 'cadet_games integer']),
